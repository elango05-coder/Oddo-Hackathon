  ...
  return (
    <div className="min-h-screen bg-slate-55 flex flex-col justify-center items-center p-4">
      <div className="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-8 text-center shadow-xl">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-755 text-white rounded-xl text-sm font-semibold transition-all duration-200"
        >
          Return to Dashboard
